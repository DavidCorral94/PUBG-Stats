...
function loadStats(info) {
    for (var k = 0; k < matchs.length; k++) {
        var stats = getInfo(info.Stats, "eu", "2017-pre3", matchs[k]);
        stats = stats[0].Stats;
        var text = "";
        var textAux = "<tr>";
        var cont = 0;
